...
class DataManager:
    ...
    def _create_dataframes(self):
        ...
        print(self.data_frames[Utils.USERID_USERDATA], list(self.data_frames[Utils.USERID_USERDATA].columns.values))
...
class AnonymousDataManager:
    ...
    @staticmethod
    def get_userid(data):
        return "{}_{}_{}_{}".format(Utils.uglify(data[Utils.SESSION_DATA][Utils.USER_CODE]),
                                       # Utils.uglify(data[Utils.SESSION_DATA][Utils.NAME]),
                                       # Utils.uglify(data[Utils.SESSION_DATA][Utils.SURNAME]),
                                       Utils.uglify(data[Utils.SESSION_DATA][Utils.DEVICE_DATA][Utils.DEVICE_MODEL]),
                                       data[Utils.SESSION_DATA][Utils.ID],
                                       data[Utils.SESSION_DATA][Utils.HANDWRITING])
    ...
    def _create_dataframes(self):
        ...
        print("------------------------------")
        # print(Utils.USERID_USERDATA)
        # print(type(self.data_frames[Utils.USERID_USERDATA]))
        # print(self.data_frames[Utils.USERID_USERDATA], list(self.data_frames[Utils.USERID_USERDATA].columns.values))

        self.data_frames[Utils.USERID_USERDATA][Utils.USER_CODE] = self.data_frames[Utils.USERID_USERDATA][Utils.USER_CODE].str.lower()
        # self.data_frames[Utils.USERID_USERDATA][Utils.SURNAME] = self.data_frames[Utils.USERID_USERDATA][Utils.SURNAME].str.lower()
        chrono.end()
...
if __name__ == '__main__':
    ...
    # s = Path(Utils.BUILD_DATASET_FOLDER(Utils.DATASET_NAME_3))
    # print(s)
    # from pprint import pprint
    # print = pprint
    # import os
    #
    # for f in s.rglob("**/*.json"):
    #     j = json.load(f.open())
    #     print(j)
    #     assert False
